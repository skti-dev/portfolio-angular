...
import { CERTIFICATES, Technologies } from "./GeneralData";

export const SKILL_ITEMS: SkillItems = [
  {
    title: Technologies.JAVASCRIPT,
    icon: faSquareJs,
    certificateUrl: CERTIFICATES.JAVASCRIPT
  },
  {
  ...
  },
  {
    ...
    icon: faAngular,
    certificateUrl: CERTIFICATES.ANGULAR
  },
  {
    title: Technologies.VUE,
    icon: faVuejs,
    certificateUrl: CERTIFICATES.VUE
  },
  {
    title: Technologies.HTML,
    icon: faHtml5,
    certificateUrl: CERTIFICATES.HTML
  },
  {
    title: Technologies.CSS,
    icon: faCss3Alt,
    certificateUrl: CERTIFICATES.CSS
  },
  {
    title: Technologies.SASS,
    icon: faSass,
    certificateUrl: CERTIFICATES.SASS
  },
  {
    title: Technologies.BOOTSTRAP,
    icon: faBootstrap,
    certificateUrl: CERTIFICATES.BOOTSTRAP
  },
  {
    title: Technologies.STYLED_COMPONENTS,
    ...
    certificateUrl: CERTIFICATES.STYLED_COMPONENTS,
  ...
  {
    title: Technologies.NODE_JS,
    icon: faNodeJs
  },
  {
    title: Technologies.PHP,
    icon: faPhp,
    certificateUrl: CERTIFICATES.PHP
  },
  {
    title: Technologies.DB,
