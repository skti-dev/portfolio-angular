...
import { faSquareJs, faAngular, faReact, faVuejs, faCss3Alt, faGitAlt, faSass, faNodeJs, faFigma, faHtml5, faBootstrap, faPhp } from '@fortawesome/free-brands-svg-icons';

export const SKILL_ITEMS: SkillItems = [
  {
    title: 'JavaScript',
    icon: faSquareJs,
    certificateUrl: 'https://www.udemy.com/certificate/UC-W7TP88QP/'
  },
  {
    title: 'TypeScript',
  ...
  },
  {
    title: 'Angular',
    icon: faAngular,
    certificateUrl: 'https://www.udemy.com/certificate/UC-7d96b532-259e-4002-ba9e-51b217734e53/?utm_source=sendgrid.com&utm_medium=email&utm_campaign=email'
  },
  {
    title: 'Vue',
    icon: faVuejs,
    certificateUrl: 'https://www.udemy.com/certificate/UC-31d08543-9b6a-45e1-b2ad-518f1ee353aa/'
  },
  {
    title: 'HTML 5',
    icon: faHtml5,
    certificateUrl: 'https://cursos.alura.com.br/certificate/augustoso/avancando-html-css'
  },
  {
    title: 'CSS 3',
    icon: faCss3Alt,
  ...
  },
  {
    title: 'SASS',
    icon: faSass,
    certificateUrl: 'https://www.udemy.com/certificate/UC-dffa16b4-d22c-49de-bfb7-b0dd1698c060/'
  },
  {
    title: 'Bootstrap',
    icon: faBootstrap,
